...
_MODEL_INFO = {
    "MobileNetV2_40_epochs.tflite": ModelSpecificInfo(
        name="MobileNetV2 image classifier for routers",
        version="v2",
        image_width=224,
        image_height=224,
        image_min=0,
    ...
    "MobileNetV2_dataset_2.tflite": ModelSpecificInfo(
        name="MobileNetV2 image classifier for routers",
        version="v3",
        image_width=224,
        image_height=224,
    ...
    "tf_lite_model1.tflite": ModelSpecificInfo(
        name="MobileNetV2 image classifier for routers",
        version="v4",
        image_width=224,
        image_height=224,
        ...
        std=[65.1505389, 62.59698394, 64.23141208],
        num_classes=4,
        author="Ahmed Ansari",
    ),
}
